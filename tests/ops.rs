...
mod tests {
    ...
    fn test_dec_zero() {
        ...
        assert_eq!(
            cpu.registers.f,
            SUBTRACTION_FLAG_BITMASK | ZERO_FLAG_BITMASK,
            "unexpected flags"
        );
    }
    ...
    fn test_add_wrap() {
        ...
        assert_eq!(
            cpu.registers.f,
            ZERO_FLAG_BITMASK | CARRY_FLAG_BITMASK | HALF_CARRY_FLAG_BITMASK
        );
    }
    ...
    fn test_cb_bit_sets_zero_and_preserves_carry() {
        ...
        assert_eq!(
            cpu.registers.f,
            ZERO_FLAG_BITMASK | HALF_CARRY_FLAG_BITMASK | CARRY_FLAG_BITMASK
        );
    }
